                ...
                <TableBody>
                  {items.map(row => (
                    <TableRow key={row.id} className="cursor-pointer" onClick={() => openInvoice(row.id)}>
                      ...
                      <TableCell>{row.customer?.name || 'عميل نقدي'}</TableCell>
