...
import { BarChart3, RefreshCw, Download, Printer } from 'lucide-react'
...
export function ReportsSection(){
  ...
  function download(format:'csv'|'xlsx'){ window.open(`/api/sync/export?format=${format}`, '_blank'); toast.success(`بدأ تنزيل ${format==='xlsx'?'Excel':'CSV'}`) }
