      ...
      >
        <DialogContent className="rounded-3xl">
          ...
          {printing && (
            ...
            >
              <div className="text-center text-xl font-black">KAYAN</div>
