...
-- Performance indexes for POS lookup, reporting and sync retry.
...
CREATE INDEX IF NOT EXISTS idx_sales_register_status_date
  ON sales(register_session_id, status, date);
